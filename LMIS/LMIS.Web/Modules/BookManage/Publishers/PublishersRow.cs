...
[DisplayName("Publishers"), InstanceName("Publishers")]
[ReadPermission("Publishers")]
[ModifyPermission("Publishers")]
[ServiceLookupPermission("Publishers")]
public sealed class PublishersRow : Row<PublishersRow.RowFields>, IIdRow, INameRow
{
