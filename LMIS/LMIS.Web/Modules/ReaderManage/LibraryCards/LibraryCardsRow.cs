...
[DisplayName("Library Cards"), InstanceName("Library Cards")]
[ReadPermission("LibraryCards")]
[ModifyPermission("LibraryCards")]
[ServiceLookupPermission("LibraryCards")]
public sealed class LibraryCardsRow : Row<LibraryCardsRow.RowFields>, IIdRow, INameRow
{
    ...
    [DisplayName("Level"), NotNull, ForeignKey(typeof(CardLevelsRow)), LeftJoin(jLevel), TextualField(nameof(LevelCardLevelName))]
    [ServiceLookupEditor(typeof(CardLevelsRow))]
    ...
    [DisplayName("Level Card Level Name"), Origin(jLevel, nameof(CardLevelsRow.CardLevelName))]
